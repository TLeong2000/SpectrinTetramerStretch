...
{ 
   ...
   */  
   ...
   /*
   // The following is a debug last resort for dealing with force accumulation across timesteps
   for (n = 0; n < nlocal; n++) {
      f[n][0] = 0;
      f[n][1] = 0;
      f[n][2] = 0;
   ...
   */
   ...
   printf("### Restraining forces called by post_force() is now complete. ###\n\n");
...
void FixArcLengthRestraint::min_post_force(int vflag) {
   ...
   */
   ...
   printf("\nBegin calculation of end-to-end distances per molecule.\n");
   ...
   */  
   ...
   printf("### Restraining forces called by min_post_force complete. ###\n\n");
